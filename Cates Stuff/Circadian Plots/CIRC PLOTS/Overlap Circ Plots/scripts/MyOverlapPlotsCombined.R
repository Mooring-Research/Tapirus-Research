...
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.7)
mtext("∆=0.81", side=3, line=0, at=-0.03, adj=-2.7, cex=0.8)
plotActivityOverlapCombined(animal2, animal3, yAxis=TRUE,letter="Lowland & Malayan")
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.7)
mtext("∆=0.84", side=3, line=0, at=-0.03, adj=-2.7, cex=0.8)
...
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.7)
mtext("∆=0.89", side=3, line=0, at=-0.03, adj=-2.7, cex=0.8)
plotActivityOverlapCombined(animal2, animal4, yAxis=TRUE,letter="Lowland & Mountain")
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.7)
mtext("∆=0.74", side=3, line=0, at=-0.03, adj=-2.7, cex=0.8)
plotActivityOverlapCombined(animal1, animal4, yAxis=FALSE,letter="Baird's & Mountain")
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.7)
mtext("∆=0.76", side=3, line=0, at=-0.03, adj=-2.7, cex=0.8)
...
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.7)
mtext("∆=0.72", side=3, line=0, at=-0.03, adj=-2.7, cex=0.8)
par(xpd=TRUE)
