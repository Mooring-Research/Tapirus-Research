###-------------------------------------------------------------------------###
### Data processing - Coyote-Ocelot avoidance
...
# Lets filter the dataset to make sure that there is only one record per species, per dar camera, per day.
...
mydata<- data.frame(CT= CT, DaysActive= p.effort, OcelotDetcs= cooc$Coyote, CayoteDetcs= cooc$Ocelot)
