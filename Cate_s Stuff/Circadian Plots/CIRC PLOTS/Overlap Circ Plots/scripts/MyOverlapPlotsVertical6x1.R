...
layout(matrix(c(1,2,3,4,5,6),nrow=6,ncol=1,byrow=FALSE))
...
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.55)
mtext("∆=0.81", side=3, line=0, at=-0.03, adj=-2.8, cex=0.8)
...
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.55)
mtext("∆=0.89", side=3, line=0, at=-0.03, adj=-2.8, cex=0.8)
...
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.55)
mtext("∆=0.76", side=3, line=0, at=-0.03, adj=-2.8, cex=0.8)
...
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.55)
mtext("∆=0.84", side=3, line=0, at=-0.03, adj=-2.8, cex=0.8)
...
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.55)
mtext("∆=0.74", side=3, line=0, at=-0.03, adj=-2.8, cex=0.8)
...
legend(x = "top", 
       ...
       lty = c(1, 2),
       cex = 0.55)
mtext("∆=0.72", side=3, line=0, at=-0.03, adj=-2.8, cex=0.8)
